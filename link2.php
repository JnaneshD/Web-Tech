...
<body id="top">
    <section id="banner" data-video="images/banner1">
        <div class="inner">
            <header>
                <img src="images/buggattilogo.png" class="nice" align="center">
                <img class="nice" src="images/ChironsportPNG.PNG" border="5" />
            </header>
        </div>
    </section>
...
<P class="Special" >-<span id="Highlight">Matt prior</span></p>
  ...
  <h3>Leave a Comment</h3>
   <form action="link2.php" method="post" id="commentform">
...
<?php
 ...
 if($_POST['Submit']){
  ...
  #Get old comments
  $old = fopen("comments1.txt", "r+t");
  $old_comments = fread($old, 1024);

  #Delete everything, write down new and old comments
  $write = fopen("comments1.txt", "w+");
